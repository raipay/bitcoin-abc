...
import { makeAlpOffer, takeAlpOffer } from './partial.test.alp.js';
...
describe('Agora Partial ALP 7450M XEC vs 2p48-1 full accept', () => {
...
describe('Agora Partial 7450M XEC vs 2p48-1 small accept', () => {
    let runner: TestRunner;
    let chronik: ChronikClient;
    let ecc: Ecc;
    ...
    it('Agora Partial ALP 7450M XEC vs 2p48-1 small accept', async () => {
        const [fuelInput, takerInput] = await makeBuilderInputs(runner, [
            10000,
            BIGSATS,
        ]);
...
describe('Agora Partial 7450M XEC vs 2p47-1 full accept', () => {
    let runner: TestRunner;
    let chronik: ChronikClient;
    let ecc: Ecc;
    ...
    it('Agora Partial ALP 7450M XEC vs 2p47-1 full accept', async () => {
        const [fuelInput, takerInput] = await makeBuilderInputs(runner, [
            10000,
            BIGSATS,
        ]);
        ...
        const acceptTxid = await takeAlpOffer({
            ...
            takerSk,
            takerInput,
            acceptedTokens: 0x7fffff380000n,
        });
...
describe('Agora Partial ALP 7450M XEC vs 2p47-1 small accept', () => {
    let runner: TestRunner;
    let chronik: ChronikClient;
    let ecc: Ecc;
    ...
    it('Agora Partial ALP 7450M XEC vs 2p47-1 small accept', async () => {
        const [fuelInput, takerInput] = await makeBuilderInputs(runner, [
            10000,
            BIGSATS,
        ]);
...
describe('Agora Partial ALP 7450M XEC vs 100 full accept', () => {
    let runner: TestRunner;
    let chronik: ChronikClient;
    let ecc: Ecc;
    ...
    it('Agora Partial ALP 7450M XEC vs 100 full accept', async () => {
        const [fuelInput, takerInput] = await makeBuilderInputs(runner, [
            10000,
            BIGSATS,
        ]);
...
describe('Agora Partial ALP 7450M XEC vs 100 small accept', () => {
    let runner: TestRunner;
    let chronik: ChronikClient;
    let ecc: Ecc;
    ...
    it('Agora Partial ALP 7450M XEC vs 100 small accept', async () => {
        const [fuelInput, takerInput] = await makeBuilderInputs(runner, [
            10000,
            BIGSATS,
        ]);
