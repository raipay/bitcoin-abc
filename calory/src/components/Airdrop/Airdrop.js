...
const Airdrop = ({ passLoadingStatus }) => {
    ...
    const handleMinEtokenBalanceChange = e => {
        ...
        if (new BigNumber(value).gt(new BigNumber(0))) {
            ...
            setIgnoreMinEtokenBalanceAmountError(
                'Minimum token balance must be greater than 0',
            );
    ...
    return (
        <>
            ...
            <StyledModal
                title="Querying the ergon blockchain"
            ...
            <SidePaddingCtn>
                <Row type="flex">
                    <Col span={24}>
                        <CustomCollapseCtn
                            panelHeader="XRG Airdrop Calculator"
                        ...
                        >
                            <Alert
                                message={`Please ensure the qualifying token transactions to airdrop recipients have at least one confirmation. The airdrop calculator will not detect unconfirmed token balances.`}
                                type="warning"
                            />
                            <br />
                            <AntdFormWrapper>
                                ...
                                >
                                    ...
                                    >
                                        <Input
                                            addonBefore="Token ID"
                                            placeholder="Enter the eSLP-20 token ID"
                                            name="tokenId"
                                    ...
                                    <Form.Item
                                        ...
                                        help={
                                            ...
                                            totalAirdropIsValid
                                                ? ''
                                                : 'Invalid total XRG airdrop'
                                        }
                                    >
                                        <Input
                                            addonBefore="Total XRG airdrop"
                                            placeholder="Enter the total XRG airdrop"
                                            name="totalAirdrop"
                                            type="number"
                                    ...
                                    <Form.Item>
                                        <AirdropOptions>
                                            ...
                                            />
                                            &ensp;Ignore airdrops below dust (
                                            {fromSatoshisToXec(
                                                appConfig.dustSats,
                                            ).toString()}{' '}
                                            XEC)
                                                    ...
                                                    <>
                                                        <Alert
                                                            description={
                                                                ...
                                                                ' XRG dust. Please increase the total XRG airdrop.'
                                                            }
                                                            type="error"
                                                            showIcon
                                                        />
