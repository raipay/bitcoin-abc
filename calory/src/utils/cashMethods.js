...
export const getChangeAddressFromInputUtxos = (inputUtxos, wallet) => {
    ...
    try {
        ...
        if (
            ...
            !isValidXrgAddress(changeAddress)
...
export const hash160ToAddress = hash160 => {
    ...
    // Because ergonaddrjs only accepts Uint8Array as input type, convert
    ...
    const ecashAddr = cashaddr.encode('ergon', 'P2PKH', hash160Uint8Array);
