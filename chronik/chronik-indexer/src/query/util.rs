...
#[cfg(feature = "plugins")]
use chronik_db::plugins::data::PluginOutput;
...
pub(crate) fn make_tx_proto(
    ...
    #[cfg(feature = "plugins")] plugin_outputs: &BTreeMap<
        OutPoint,
        PluginOutput,
    >,
) -> proto::Tx {
    proto::Tx {
        ...
        token_is_invalid: token.map_or(false, |token| {
            !token.tx.failed_parsings.is_empty()
