...
use chronik_plugin_common::{
    config::PluginConfig,
    data::{PluginOutput, PluginOutputEntry, PluginTxOutputs},
};
use chronik_util::log;
pub use pyo3::Python;
use pyo3::{
    types::{PyDict, PyList, PyModule},
    PyAny, PyErr, PyObject, PyResult,
};
...
version = platform.python_version()
    ...
    pub fn run_plugin_outputs(
        ...
        let py_tx = tx_module.bridge_tx(py, tx, plugin_outputs, token_data)?;
        ...
        for plugin in &self.plugins {
            ...
            for (idx, output) in outputs.iter().enumerate() {
                ...
                let entry = result
                    .outputs
                    .entry(output_idx)
                    .or_insert(PluginOutput::default())
                    .plugins
                ...
                match entry {
                    ...
                    Entry::Vacant(vacant) => {
                        vacant.insert(PluginOutputEntry {
                            groups: groups
                                .into_iter()
