...
void SetupServerArgs(NodeContext &node) {
    ...
    argsman.AddArg("-chronikscripthistorycuckoofilter",
                   ...
                   ArgsManager::ALLOW_BOOL, OptionsCategory::CHRONIK);
    argsman.AddArg("-chronikscripthistoryfiltervariant",
                   "Which filter optimization to use",
                   ArgsManager::ALLOW_INT, OptionsCategory::CHRONIK);
    argsman.AddArg(
    ...
    argsman.AddArg("-chronikscripthistorycachesize",
                   ...
                   ArgsManager::ALLOW_ANY, OptionsCategory::CHRONIK);
    argsman.AddArg("-chronikscripthistorycachevariant",
                   "Which cache to use for the script history",
                   ArgsManager::ALLOW_ANY, OptionsCategory::CHRONIK);
